// Uses a neural network to learn and guess whether the background color is
// closer to black or white (for optimal readability) based on random RGB values,
// and re-trains the model based on user input.
